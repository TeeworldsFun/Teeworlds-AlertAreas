...
void CAIrobot1::OnCharacterSpawn(CCharacter *pChr)
{
	...
	if (m_Skin == SKIN_ROBO1)
	{
		...
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetModularWeapon(3, 4)));
	}
	...
	else if (m_Skin == SKIN_ROBO3)
	{
		...
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetModularWeapon(1, 2)));
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetStaticWeapon(SW_GRENADE1)));
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetStaticWeapon(SW_GRENADE1)));
		pChr->m_Kits = 1;
	}
	else if (m_Skin == SKIN_ROBO4)
	{
		...
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetChargedWeapon(GetModularWeapon(3, 1+rand()%4), 2)));
		pChr->m_Kits = 1;
	}
	else if (m_Skin == SKIN_ROBO5)
	{
		...
		pChr->GiveCustomWeapon(GameServer()->NewWeapon(GetChargedWeapon(GetModularWeapon(6, 9), 2)));
